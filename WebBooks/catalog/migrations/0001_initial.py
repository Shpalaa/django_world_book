# Generated by Django 4.0.4 on 2022-10-11 19:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='input name author', max_length=100, verbose_name='Имя автора')),
                ('last_name', models.CharField(help_text='input surname author', max_length=100)),
                ('date_of_birth', models.DateField(blank=True, help_text='input date of birth', null=True, verbose_name='Дата рождения')),
                ('date_of_death', models.DateField(blank=True, help_text='input date of death', null=True, verbose_name='Дата смерти')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='input name book', max_length=200, verbose_name='Название книги')),
