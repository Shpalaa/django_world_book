...
class Author(models.Model):
    ...
    last_name = models.CharField(max_length=100,
                                 help_text='input surname author',
                                 verbose_name='Фамилия автора')
    date_of_birth = models.DateField(help_text='input date of birth',
                                     verbose_name='Дата рождения',
                                     null=True, blank=True)
    date_of_death = models.DateField(help_text='input date of death',
...
class Book(models.Model):
    ...
    def display_author(self):
        return ", ".join([author.last_name for author
                          in self.author.all()])
